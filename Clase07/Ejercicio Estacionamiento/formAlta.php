	...
	<div class="container">
		...
		<div class="CajaInicio animated bounceInRight">
			...
			<form id="FormIngreso" method="post" action="formAlta.php" enctype="multipart/form-data" >
				<input type="text" name="patente" id="patente" placeholder="ingrese la patente" value="<?php echo isset($unaPersona) ?  $unaPersona->GetApellido() : "" ; ?>" /><span id="lblApellido" style="display:none;color:#FF0000;width:1%;float:right;font-size:80">*</span>
